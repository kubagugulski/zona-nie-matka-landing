...
import { Download, CheckCircle, HeartHandshake } from 'lucide-react';
        ...
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl border border-rose-100 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg text-stone-600 mb-8 leading-relaxed">
              Płatność przebiegła pomyślnie. Twoja checklista "Randka z samą sobą" jest gotowa do pobrania.
            </p>
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="flex flex-col">
                    <span className="font-bold text-stone-800 group-hover:text-rose-600 transition-colors">Checklista "Randka z samą sobą"</span>
